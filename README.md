...
| 名称                                                   | 描述                               |
|------------------------------------------------------|----------------------------------|
| [threejs](https://github.com/mrdoob/three.js)        | 开源示例比较多的库，但目前只支持webgl，不支持webgpu等 |
| [vtk-js](https://github.com/kitware/vtk-js)          | 与工业软件比较相符，只不过有些复杂的部分暂时没有用js实现    |
| [babylonjs](https://github.com/BabylonJS/Babylon.js) | 社区活跃度较高，支持webgpu                 |
